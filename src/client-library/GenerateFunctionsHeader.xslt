...
{
public:
    using PacketFunctions_</xsl:text><xsl:value-of select="$subNamespace"/><xsl:text>_Custom::PacketFunctions_</xsl:text><xsl:value-of select="$subNamespace"/><xsl:text>_Custom;
</xsl:text>
